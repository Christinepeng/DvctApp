...
class AcceptGroupInviteUseCase @Inject
constructor(
    @Named("executor_thread") executorThread: Scheduler,
    @Named("ui_thread") uiThread: Scheduler,
    private val repository: GroupRepository
) : UseCase<Unit, AcceptGroupInviteUseCase.Params>(executorThread, uiThread) {

    override fun createObservableUseCase(params: Params): Observable<Unit> {
        return repository.acceptGroupInvite(params.inviteId)
    }
    ...
    class Params private constructor(val inviteId: String) {
        ...
        companion object {
            ...
            fun toAccept(inviteId: String): Params {
