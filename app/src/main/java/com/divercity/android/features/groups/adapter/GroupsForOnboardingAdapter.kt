...
class GroupsForOnboardingAdapter @Inject
constructor() : PagedListAdapter<GroupResponse, RecyclerView.ViewHolder>(userDiffCallback) {
    ...
    fun setListener(listener: GroupsForOnboardingViewHolder.Listener) {
        this.listener = listener
    }

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        return when (viewType) {
            R.layout.item_group_onboarding -> GroupsForOnboardingViewHolder.create(parent, listener)
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        when (getItemViewType(position)) {
            R.layout.item_group_onboarding -> (holder as GroupsForOnboardingViewHolder).bindTo(position, getItem(position))
