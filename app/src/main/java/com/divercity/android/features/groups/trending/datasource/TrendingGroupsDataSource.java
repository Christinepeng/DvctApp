...
public class TrendingGroupsDataSource extends PageKeyedDataSource<Long, GroupResponse> {

    private static final String TAG = TrendingGroupsDataSource.class.getSimpleName();
    ...
    public TrendingGroupsDataSource(CompositeDisposable compositeDisposable,
    ...
    public void loadInitial(@NonNull final LoadInitialParams<Long> params, @NonNull final LoadInitialCallback<Long, GroupResponse> callback) {
        ...
        fetchGroupsUseCase.execute(disposableObserver, FetchTrendingGroupsUseCase.Params.Companion.forGroups(0, params.requestedLoadSize, query));
    }
    ...
    public void loadAfter(@NonNull final LoadParams<Long> params, @NonNull final LoadCallback<Long, GroupResponse> callback) {
        ...
        compositeDisposable.add(disposableObserver);
        fetchGroupsUseCase.execute(disposableObserver, FetchTrendingGroupsUseCase.Params.Companion.forGroups(params.key.intValue(), params.requestedLoadSize, query));
    }
