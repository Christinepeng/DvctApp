...
public class GroupsInterestsDataSource extends PageKeyedDataSource<Long, HomeItem> {
    ...
    public GroupsInterestsDataSource(FetchQuestionsJobsUseCase getQuestionsUseCase,
    ...
    public void loadAfter(@NonNull final LoadParams<Long> params, @NonNull final LoadCallback<Long, HomeItem> callback) {
        ...
        getQuestionsUseCase.execute(disposableObserver, FetchQuestionsJobsUseCase.Params.Companion.forJobs(params.key.intValue(), params.requestedLoadSize, null));
    }
