package com.divercity.android.features.profile.tabfollowing.usecase
...
) : UseCase<@JvmSuppressWildcards List<UserResponse>, FetchFollowingUseCase.Params>(executorThread, uiThread) {
