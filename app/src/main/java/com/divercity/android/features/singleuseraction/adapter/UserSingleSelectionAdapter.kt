package com.divercity.android.features.singleuseraction.adapter
...
class UserSingleSelectionAdapter @Inject
constructor() : PagedListAdapter<Any, RecyclerView.ViewHolder>(userDiffCallback) {
    ...
    private var listener = object :
        UserSingleSelectionViewHolder.Listener {
    ...
    fun getUserSelected(): UserResponse? {
        return if (lastPositionSelected != null)
            getItem(lastPositionSelected!!) as UserResponse
        else
            null
    }
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        return when (viewType) {
            R.layout.item_user -> UserSingleSelectionViewHolder.create(
                parent,
                listener
            )
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        when (getItemViewType(position)) {
            R.layout.item_user -> (holder as UserSingleSelectionViewHolder).bindTo(
                lastPositionSelected == position,
