...
public class TabGroupsPanelViewPagerAdapter extends PagerAdapter {
    ...
    @Inject
    public TabGroupsPanelViewPagerAdapter(Context context) {
    ...
    public Object instantiateItem(final ViewGroup container, final int position) {
        ...
        View view = layoutInflater.inflate(R.layout.view_pager_panel_group, null);
