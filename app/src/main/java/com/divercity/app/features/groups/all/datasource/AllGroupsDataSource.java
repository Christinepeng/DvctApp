...
public class AllGroupsDataSource extends PageKeyedDataSource<Long, GroupResponse> {

    private static final String TAG = AllGroupsDataSource.class.getSimpleName();
