...
public class HomeViewModel extends BaseViewModel {
    ...
    private QuestionsPaginatedRepository questionsRepository;

    private GetStoriesFeatured getStoriesFeatured;

    @Inject
    public HomeViewModel(@NonNull Application application,
                         QuestionsPaginatedRepository questionsRepository,
                         GetStoriesFeatured getStoriesFeatured) {
        super(application);
        this.questionsRepository = questionsRepository;
        questionListing = questionsRepository.fetchQuestions();
