            ...
            it.attributes?.isBookmarkedByCurrent?.let { isBookmarkedByCurrent ->
                if (isBookmarkedByCurrent) {
                    ViewCompat.setBackgroundTintList(
                            itemView.item_jobs_btn_save, ContextCompat.getColorStateList(itemView.context, R.color.appBlue))
                    itemView.item_jobs_txt_save.setTextColor(ContextCompat.getColor(itemView.context, R.color.appBlue))
