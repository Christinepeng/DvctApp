...
import com.divercity.app.features.onboarding.selectindustry.adapter.IndustryAdapter
import com.divercity.app.features.onboarding.selectindustry.adapter.IndustryViewHolder
...
class SelectIndustryFragment : BaseFragment(), RetryCallback {
    ...
    companion object {
        ...
        fun newInstance(progress: Int): SelectIndustryFragment {
            val fragment = SelectIndustryFragment()
    ...
    private fun setupHeader() {
        ...
        include_header.apply {
            ...
            txt_title.setText(R.string.select_your_indsutry)
