...
public class SelectIndustryViewModel extends BaseViewModel {
    ...
    public LiveData<PagedList<IndustryResponse>> companyList;
    private Listing<IndustryResponse> companyListListing;
    IndustryPaginatedRepository repository;

    @Inject
    public SelectIndustryViewModel(@NonNull Application application,
                                   IndustryPaginatedRepository repository) {
        super(application);
