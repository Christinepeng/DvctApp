...
import com.divercity.app.features.profile.selectmajor.datasource.MajorDataSource;
import com.divercity.app.features.profile.selectmajor.datasource.MajorDataSourceFactory;
...
public class MajorPaginatedRepositoryImpl implements MajorPaginatedRepository {
    ...
    @Override
    public Listing<MajorResponse> fetchMajors(@Nullable String query) {
